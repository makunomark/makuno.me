                ...
                <Layout>
                  <Div>
                    <Typing>
                      ...
                      Sometimes, I use{" "}
                      <a href="https://reactnative.dev/">React Native</a> to
                      build cross platform applications on both Android and iOS.{" "}
                      <Typing.Delay ms={300} />
                      <br />
                      ...
                      <Typing.Delay ms={300} />
                      <br />
                      <br /> I use <a>Node</a> to write server side
                      applications. Recently, I have been trying to use Kotlin.
                ...
                <Layout>
                  <Div>
                    <Typing>
                      ...
                      <br />
                      <br />I enjoy touching other parts of the stack. Recently,
                      I have been writing cloud functions to deliver reports to
                      our users through the app.
                    </Typing>
                  </Div>
                </Layout>
              </div>
